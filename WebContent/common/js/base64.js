...
var CryptoJS = CryptoJS || function(h, o) {
    var f = {}, j = f.lib = {}, k = j.Base = function() {
        ...
        return {extend: function(b) {
    ...
    }(), i = j.WordArray = k.extend({init: function(a, b) {
            a = 
            this.words = a || [];
            ...
            return i.create(b, a)
        }}), l = f.enc = {}, p = l.Hex = {stringify: function(a) {
        ...
        }}, m = j.BufferedBlockAlgorithm = k.extend({reset: function() {
            this._data = i.create();
            this._nDataBytes = 0
        },_append: function(a) {
    ...
    j.Hasher = m.extend({init: function() {
            this.reset()
        },
        reset: function() {
            m.reset.call(this);
