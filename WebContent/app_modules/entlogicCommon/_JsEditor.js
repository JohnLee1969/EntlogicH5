...
function loadCodeFile(filePath) {
	...
	var dataPackage = postBpService(applicationRoot, "com.entlogic.h5.services.FileService", "loadTextFile", parameters);
...
function saveCodeFile() {
	...
	postBpService(applicationRoot, "com.entlogic.h5.services.FileService", "saveTextFile", parameters);
};
