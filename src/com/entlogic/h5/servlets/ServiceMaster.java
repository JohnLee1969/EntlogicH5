 ...
 * @version 1.0
 */
public class ServiceMaster extends HttpServlet implements Serializable
{
	/**
	 * serialVersionUID
	 */
	...
	private void doService(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try
		{
			...
			data = Base64.base64_decodeToUtf8(data);
			Log.info(data);
			...
			response(res, Base64.base64_encode(retrunPackage.toJSON()));
