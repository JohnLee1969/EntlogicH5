...
function btnNext_click() {
    ...
    // 创建新企业账号
    var drNew = dboHS_ENTERPRISE.execCreate();
    enterpriseOid = drNew.getValue("id");
    drNew.setItem("OID", enterpriseOid);
    drNew.setItem("NAME", "新注册企业");
    drNew.setItem("ACCOUNT", txtMobile.getValue());
    drNew.setItem("PASSWORD", "new");
    drNew.setItem("STATUS", "1");
    dboHS_ENTERPRISE.execInsert(drNew);
