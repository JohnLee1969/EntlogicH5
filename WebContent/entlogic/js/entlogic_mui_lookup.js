 ...
 * @parameter formControls
  */ 
function entlogic_mui_lookup(containerId, formControls) {
	...
	_input.click(function() {
		application.popUpMobLookupForm(_this.lookupUrl,  _callBackFuction);
	});
	
	// 查找框文查找按钮
	var _button = $("<span class='lookup-btn' value=''>&#xe6a3;</span>");
	_button.appendTo(_container);	
	_button.click(function() {
		popUpMobLookupForm(_this.lookupUrl,  _callBackFuction);
	});
