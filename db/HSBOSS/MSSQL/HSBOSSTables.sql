 ...
 * Author :       Microsoft
 *
 * Date Created : Friday, August 23, 2019 11:09:57
...
CREATE TABLE HS_BIZ_LOG(
    ...
    CONSTRAINT PK64 PRIMARY KEY CLUSTERED (OID)
)
go



IF OBJECT_ID('HS_BIZ_LOG') IS NOT NULL
    PRINT '<<< CREATED TABLE HS_BIZ_LOG >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE HS_BIZ_LOG >>>'
go
...
CREATE TABLE HS_DIRECTOR(
    OID              varchar(50)     NOT NULL,
    HS_ENTERPRISE    varchar(50)     NOT NULL,
    ACCOUNT          varchar(50)     NULL,
    PASSWORD         varchar(50)     NULL,
    MOBILE           varchar(50)     NULL,
    WX_ACOUNT        varchar(50)     NULL,
    CERT_CODE        varchar(50)     NULL,
    ...
    CERT_PIC         varchar(255)    NULL,
    CREATE_TIME      datetime        NULL,
    STATUS           varchar(50)     NULL,
    CONSTRAINT PK62 PRIMARY KEY CLUSTERED (OID)
)
go



IF OBJECT_ID('HS_DIRECTOR') IS NOT NULL
    PRINT '<<< CREATED TABLE HS_DIRECTOR >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE HS_DIRECTOR >>>'
go
...
CREATE TABLE HS_ENTERPRISE(
    ...
    LP_CERT_PIC_A             varchar(255)      NULL,
    LP_CERT_PIC_B             varchar(255)      NULL,
    BANK                      varchar(255)      NULL,
    SUBBANK                   varchar(255)      NULL,
...
CREATE TABLE HS_PROVIDE_CONTRACT(
    ...
    START_TIME         datetime          NULL,
    END_TIME           datetime          NULL,
    ENTERPRISE_COMM    numeric(10, 2)    NULL,
    PLATFORM_COMM      numeric(10, 2)    NULL,
    NOTE               varchar(2000)     NULL,
...
CREATE TABLE HS_WORKER(
    OID                  varchar(50)       NOT NULL,
    OWNER                varchar(50)       NULL,
    HS_ENTERPRISE        varchar(50)       NULL,
    HS_DIRECTOR          varchar(50)       NULL,
    HEAD_PIC             varchar(256)      NULL,
    CERT_TYPE            varchar(50)       NULL,
    CERT_CODE            varchar(50)       NULL,
    CERT_PIC             varchar(256)      NULL,
    NAME                 varchar(256)      NULL,
    SEX                  varchar(50)       NULL,
    BIRTHDAY             date              NULL,
    ...
    MEDALS               varchar(256)      NULL,
    TOTAL_POINTS         numeric(10, 2)    NULL,
    BANK                 varchar(255)      NULL,
    SUBBANK              varchar(255)      NULL,
    BANK_ACCOUNT         varchar(50)       NULL,
    NOTE                 varchar(1024)     NULL,
...
/* 
 * TABLE: HS_WORKER_AUDIT 
 */

CREATE TABLE HS_WORKER_AUDIT(
    OID                    varchar(50)     NOT NULL,
    HS_WORKER              varchar(50)     NOT NULL,
    ...
    CERT_TYPE              varchar(50)     NULL,
    CERT_CODE              varchar(50)     NULL,
    CERT_AUDIT_STA         varchar(10)     NULL,
    MOBILE_AUDIT_STATUS    varchar(10)     NULL,
    CREDIT_AUDIT_STA       varchar(10)     NULL,
    CREATE_TIME            datetime        NULL,
    DATA       			   varchar(1024)     NULL,
    CONSTRAINT PK66 PRIMARY KEY CLUSTERED (OID)
)
go



IF OBJECT_ID('HS_WORKER_AUDIT') IS NOT NULL
    PRINT '<<< CREATED TABLE HS_WORKER_AUDIT >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE HS_WORKER_AUDIT >>>'
go
...
/* 
 * TABLE: HS_WORKER_MEDALS 
 */

CREATE TABLE HS_WORKER_MEDALS(
    OID             varchar(50)    NOT NULL,
    HS_WORKER       varchar(50)    NOT NULL,
    SERVICE_TYPE    varchar(50)    NULL,
    MEDAL_TYPE      varchar(50)    NULL,
    GRANT_DATE      date           NULL,
    CONSTRAINT PK60 PRIMARY KEY CLUSTERED (OID)
)
go



IF OBJECT_ID('HS_WORKER_MEDALS') IS NOT NULL
    PRINT '<<< CREATED TABLE HS_WORKER_MEDALS >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE HS_WORKER_MEDALS >>>'
go
...
CREATE TABLE HS_WORKER_SERVICE(
    ...
    HS_SERVICE      varchar(50)       NOT NULL,
    PRIORITY        int               NULL,
    TAKING_TYPE     varchar(20)       NULL,
    MIN_RATE        numeric(10, 2)    NULL,
    MIN_QUANTITY    numeric(10, 2)    NULL,
    MAX_DISTANCE    numeric(10, 1)    NULL,
    NOTE            varchar(256)      NULL,
...
ALTER TABLE HS_DIRECTOR ADD CONSTRAINT RefHS_ENTERPRISE94 
...
ALTER TABLE HS_WORKER ADD CONSTRAINT RefHS_DIRECTOR97 
    FOREIGN KEY (HS_DIRECTOR)
    REFERENCES HS_DIRECTOR(OID)
go

ALTER TABLE HS_WORKER ADD CONSTRAINT RefHS_ENTERPRISE98 
    FOREIGN KEY (HS_ENTERPRISE)
    REFERENCES HS_ENTERPRISE(OID)
go
...
ALTER TABLE HS_WORKER_AUDIT ADD CONSTRAINT RefHS_WORKER100 
    FOREIGN KEY (HS_WORKER)
    REFERENCES HS_WORKER(OID)
go
...
ALTER TABLE HS_WORKER_MEDALS ADD CONSTRAINT RefHS_WORKER92 
    FOREIGN KEY (HS_WORKER)
    REFERENCES HS_WORKER(OID)
go
