...
function entlogic_mui_tab(containerId, mode) {
	...
	if (mode != "h")  _cssContainer = "emui-tab-container-v";
	
	// 头容器样式
	var _cssHead = "emui-tab-head-h";
	if (mode != "h")  _cssHead = "emui-tab-head-v";
	...
	if (mode != "h")  _cssTab = "emui-tab-v";
	var _cssTabSelected = "emui-tab-selected-h";
	if (mode != "h")  _cssTabSelected = "emui-tab-selected-v";
