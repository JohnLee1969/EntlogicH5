 ...
 * Author :       John
 *
 * Date Created : Monday, July 15, 2019 13:31:35
...
ALTER TABLE FW_GROUP_APP ADD CONSTRAINT RefFW_MENU19 
    FOREIGN KEY (APPLICATION)
    REFERENCES FW_MENU(OID)
go

ALTER TABLE FW_GROUP_APP ADD CONSTRAINT RefFW_GROUP20 
...
ALTER TABLE FW_ROLE ADD CONSTRAINT RefFW_GROUP13 
    FOREIGN KEY (GROUP_OID)
    REFERENCES FW_GROUP(OID)
go
