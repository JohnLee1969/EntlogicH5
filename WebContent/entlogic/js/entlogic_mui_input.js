 ...
 * @returns
 */
function entlogic_mui_sm_checkcode(containerId, input) {
	// this副本
	var _this = this;
	...
	_container.html("获取验证码");
	
	var _time = 60;
	var _timer = null;
	var _timerHandler = function() {
		_time  --;
		_container.html(_time + "秒后重获");
		if (_time <=  0) {
	...
	_container.click(function() {
		if (_time < 60 ) return;
		var result = _this.buttonClick();
		if(result)
		{
			 var parameter = new entlogic_data_record();
			 parameter.addItem("phone", input.getValue());
			 var dataPackage = postBpService(applicationRoot, "com.entlogic.h5.services.VerificationService", "getSmCheckCode", parameter);
			 if (dataPackage != null) {
				 _this.smCheckCode = dataPackage.getReturn("result");		
				 _time = 60;
				_timer = window.setInterval(_timerHandler, 1000);
...
/**
 * entlogic_mui_textarea: 多行文本输入框
 * 
 * @parameter containerId
 * @parameter formControls
  */ 
function entlogic_mui_textarea(containerId, formControls) {
...
/**
 * entlogic_mui_text: 文本输入框
 * 
 * @parameter containerId
 * @parameter formControls
  */ 
function entlogic_mui_text(containerId, formControls) {
 ...
 * @parameter formControls
  */ 
function entlogic_mui_number(containerId, formControls) {
...
/**
 * entlogic_mui_datetiime: 日期时间输入框
 * 
 * @parameter containerId
 * @parameter formControls
  */ 
function entlogic_mui_datetime(containerId, formControls) {
...
/**
 * entlogic_mui_date: 日期输入框
 * 
 * @parameter containerId
 * @parameter formControls
  */ 
function entlogic_mui_date(containerId, formControls) {
